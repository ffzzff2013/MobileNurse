...
/* JavaScript content from js/BarcodePlugin.js in folder android */
/**
 * 
 */
...
BarcodeScanner.prototype.scan = function(types, success , fail, options) {
    ...
    cordova.exec(function(args) {
        ...
        fail(args);
    }, 'BarcodePlugin', 'scan', [types, installTitle, installMessage, yesString, noString]);
};
BarcodeScanner.prototype.encode = function(type, data, success, fail, options) {
	...
	cordova.exec(function(args) {
        ...
        fail(args);
    }, 'BarcodePlugin', 'encode', [types, installTitle, installMessage, yesString, noString]);
};
